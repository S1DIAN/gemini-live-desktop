...
export function DeviceSelectors(props: DeviceSelectorsProps) {
  ...
  return (
    <SectionCard title={copy.deviceSelectors.title}>
      <div className="settings-list">
        <SettingsRow
          label={copy.deviceSelectors.microphone}
          control={
            <select
        ...
        />
        <SettingsRow
          label={copy.deviceSelectors.output}
          control={
            <select
        ...
        />
        <SettingsRow
          label={copy.deviceSelectors.camera}
          control={
            <select
        ...
        />
        <SettingsRow
          label={copy.deviceSelectors.screenSource}
          control={
            <select
